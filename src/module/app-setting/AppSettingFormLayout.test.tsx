...
import { render, screen, within } from '@/shared/utils/mockThemeProvider';
...
//Mocking getNextLocale
jest.mock('@/shared/utils/actions', () => ({
  getNextLocale: jest.fn(),
}));
...
//     en: {
//       'Shared.darkTheme': 'Dark Theme',
//       'Shared.lightTheme': 'Light Theme',
//       'Shared.theme': 'Theme',
//       'AppSettingPage.language': 'Language',
//       'AppSettingPage.title': 'App Settings',
//       'AppSettingPage.subtitle': 'Change your app settings',
//     },

//     zhcn: {
//       'Shared.darkTheme': '暗色',
//       'Shared.lightTheme': '浅色',
//       'Shared.theme': '主题',
//       'AppSettingPage.language': '语言',
//       'AppSettingPage.title': '系统设置',
//       'AppSettingPage.subtitle': '更新您的系统设置',
//     },
//   };
