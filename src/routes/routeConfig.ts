...
import ResetPassword from 'app/(auth)/resetpasswor/page';
import ResetPasswordForm from 'app/(auth)/resetpasswor/_components/form';
import PasswordResetSuccess from 'app/(auth)/resetpasswor/_components/success';
