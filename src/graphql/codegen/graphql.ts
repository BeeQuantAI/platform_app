...
export type MutationLoginArgs = {
  email: Scalars['String']['input'];
  password: Scalars['String']['input'];
  stay_signed_in: Scalars['Boolean']['input'];
};
...
export type LoginMutation = {
  __typename?: 'Mutation';
  login: { __typename?: 'Result'; code: number; message?: string | null; data?: string | null };
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'stay_signed_in' } },
          type: {
            kind: 'NonNullType',
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'stay_signed_in' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'stay_signed_in' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
