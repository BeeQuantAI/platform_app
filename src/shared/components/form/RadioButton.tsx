...
import { colorAccent, colorAccentHover, colorIcon, colorText, colorWhite } from '@/styles/palette';
...
interface RadioButtonProps {
  ...
  disabled?: boolean;
  radioValue?: string;
  styleType?: 'colored' | 'button' | 'colored-click' | undefined;
}

interface RadioButtonWrapProps {
  disabled?: boolean;
  styleType?: string;
}
...
const RadioButtonWrap = styled.label<RadioButtonWrapProps>`
  display: inline-block;
  cursor: pointer;
